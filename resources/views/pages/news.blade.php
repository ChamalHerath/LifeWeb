...
@section('content')
    ...
    <!-- ======= Our Team Section ======= -->
    <section id="news" class="team section-bg mt-4 pt-4">
        <div class="container">
            <div class="section-header">
                <h2 style="color: #a8cf45">News</h2>
                <p style="font-size: 20px"><b>COOPLIFE Insurance - Recorded its highest no. of <i
                            style="color: #3b5998">Million Dollar Round
                            Table</i> achievers
                        with the first ever
                        COT achiever, since inception,</b></p>
            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member" data-aos="fade-up">
                        ...
                        <div class="member-info">
                            ...
                            <span>Managing Director - CoopLife Insurance</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8 col-md-6">
                    <ul style="list-style-type: square">
                        <li>Colombo, Sri Lanka, January 10th, 2022: COOPLIFE Insurance makes its history with an all-new
                            ...
                            over the past couple of years.</li><br>
                        <li>MDRT is a global, independent association of the world’s leading life insurance and financial
                            ...
                            to produce its first Top of the Table achiever in near future.</li><br>
                        <li>“Professional development through dedication” is no doubt the cornerstone of our sales force
                            advancement. We invest significantly on human development and its digitization which believes to
                            be the leading-edge in continuous improvement of the business.</li><br>
                        <li>Customer-centricity is our main concern of everything we do, and it makes our team demonstrate
                            ...
                            all.</li><br>
                        <li>This prestigious achievement comes hot on the heels of a fruitful year for CoopLife Insurance
                            ...
                            country</li><br>
                        <li>Reflecting more on the hardships of the previous year, – as the Managing Director of CoopLife,
                            ...
                            outfit of the country”.</li><br>
                        <li>COOPLIFE Insurance is a fully owned subsidiary of Cooperative Insurance Company Ltd, an emerging
                            ...
                            from the investors as a part of general public of the nation</li><br>
                        <li>In the journey towards empowering the Sri Lankan Dream, CoopLife Insurance offers Life Insurance
