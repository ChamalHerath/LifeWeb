        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 about-img">
                    <img src="assets/img/png/1.png" alt="">
                </div>
                ...
                <div class="col-lg-6 content">
                    <ul>
                        ...
                        <li><i class="fa fa-check-circle"></i> We take pride in being responsible for changing the customer
                            perception towards the Life Insurance business by crafting integrated stakeholder groups that
                            reap
                            the benefits of our partnership by eradicating the exploitation and misbehavior to ensure
                            security
                            and transparency for all… </li><br>
                    </ul>
                </div>
                <div class="col-lg-6 about-img">
                    <img src="assets/img/png/2.png" alt="">
                </div>
            </div>
                ...
                <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"> Life insurance company that will stand <strong>"UNITED"</strong> with
                                its
                                customers to the
                                very end.</p>
                        </div>
                ...
                <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">To be ever mindful of the needs of our customers, and thereby make
                                ‘true
        ...
        <div class="container mt-0 pt-0">
            ...
            <div class="row">
                <div class="col-lg-4 about-img">
                    <img src="assets/img/png/3.png" alt="">
                </div>
